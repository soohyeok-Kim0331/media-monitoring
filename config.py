...
# ----------------------------------------------------------------------------
# (선택) 사이트에서 '재검색 실행' 버튼으로 GitHub Actions를 자동 호출하기.
# Cloudflare Worker를 배포한 뒤 그 주소를 여기에 넣으면 버튼이 나타납니다.
# 비워두면 버튼 없이 '재검색 목록 복사'(수동 붙여넣기)만 동작합니다.
# WORKER_URL     : 배포한 Worker 주소 (예: https://media-trigger.내계정.workers.dev)
# TRIGGER_SECRET : Worker와 똑같이 맞춘 임의 암호 문자열 (드라이브 남용 방지용 약한 잠금)
# ----------------------------------------------------------------------------
WORKER_URL = "https://media-trigger.soohyeok3105.workers.dev"
TRIGGER_SECRET = "mm-2026-kc7788"
